...
%prep
%setup -q -n cfgv-3.4.0
cd %{_builddir}/cfgv-3.4.0
pushd ..
cp -a cfgv-3.4.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1692026707
...
cp %{_builddir}/cfgv-%{version}/LICENSE %{buildroot}/usr/share/package-licenses/pypi-cfgv/e40bc52991f4a8aeed9b655de7dc4f7ea9b836fe || :
